...
def create_mobilenetv3_model(num_classes=3, pretrained=True, mobilenet_version="mobilenet_v3_small"):
...
def load_mobilenetv3_model(model_path, num_classes=3, mobilenet_version="mobilenet_v3_small", device="cpu"):
